...
destinations_country = '00, DE'
destinations_country_l = KEYVALUE_SEP_V1.join(['destinations_country',
...
latest_bandwidth_l = KEYVALUE_SEP_V1.join(['latest_bandwidth',
                                          latest_bandwidth])
header_ls = [timestamp_l, version_l, destinations_country_l, file_created_l,
             latest_bandwidth_l,
...
def test_v3bwheader_str():
    ...
    header = V3BWHeader(timestamp_l, scanner_country=scanner_country,
                        destinations_country=destinations_country,
