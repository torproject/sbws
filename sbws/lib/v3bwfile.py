...
EXTRA_ARG_KEYVALUES = ['software', 'software_version', 'file_created',
                       ...
                       'scanner_country', 'destinations_country']
...
class V3BWHeader(object):
    ...
    def from_results(cls, results, scanner_country=None,
                     destinations_country=None, state_fpath=''):
        kwargs = dict()
        ...
        if destinations_country is not None:
            kwargs['destinations_country'] = destinations_country
